import fire
from contrib.fitness.minecraft.twod.composed.composed_house import Minecraft2DComposedHouseFitness
...
def main(letter):
    ...
    {
        'aa': lambda LET: run_mcc(NUM, LET, level_class=Composed2DHouseLevel, use_one_hot_encoding=False, additional_fitnesses=[Minecraft2DComposedHouseFitness], distance_function=visual_diversity_normalised, max_dist=1, pop_size=50, generations=(g:= 150), dimensions=3, NUM_SEEDS=NUM_SEEDS, do_padding_randomly=False ,number_of_random_variables=1, random_perturb_size=0, multiple_iterations=10, USE_RAY=False, all_weights=[0, 0, 1], generator_kwargs=dict(input_center_tile=True, start_level_with_default_tile=True,  progress_default_tile=0), num_levels=5, intra_novelty_neighbours=4),
        
        'zz': lambda LET: run_mcc(NUM, LET, level_class=Composed2DHouseLevel, use_one_hot_encoding=True, additional_fitnesses=[Minecraft2DComposedHouseFitness], distance_function=visual_diversity_normalised, max_dist=1, pop_size=50, generations=(g:= 150), dimensions=3, NUM_SEEDS=NUM_SEEDS, do_padding_randomly=False ,number_of_random_variables=1, random_perturb_size=0, multiple_iterations=5, USE_RAY=False, all_weights=[0, 0, 1], generator_kwargs=dict(input_center_tile=True, start_level_with_default_tile=True,  progress_default_tile=0), num_levels=5, intra_novelty_neighbours=4),
        
        'zzz': lambda LET: run_mcc(NUM, LET, level_class=Composed2DHouseLevel, use_one_hot_encoding=False, additional_fitnesses=[Minecraft2DComposedHouseFitness], distance_function=visual_diversity_normalised, max_dist=1, pop_size=50, generations=(g:= 150), dimensions=3, NUM_SEEDS=NUM_SEEDS, do_padding_randomly=False ,number_of_random_variables=1, random_perturb_size=0, multiple_iterations=5, USE_RAY=False, all_weights=[0, 0, 1], generator_kwargs=dict(input_center_tile=True, start_level_with_default_tile=True,  progress_default_tile=0), num_levels=5, intra_novelty_neighbours=4),
    }[letter](letter)
