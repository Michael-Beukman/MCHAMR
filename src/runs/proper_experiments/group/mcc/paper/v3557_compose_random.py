import fire
from contrib.fitness.minecraft.twod.composed.random_layouts_fitness import Minecraft2DComposedTownRandomLayoutFitness
...
def main(letter_to_use):
    ...
    ALL_FITS = [get_fitness_with_additional_arguments(Minecraft2DComposedTownRandomLayoutFitness, index_to_use=i) for i in range(20)]
    a = 0
    b = 0
    D = {}
