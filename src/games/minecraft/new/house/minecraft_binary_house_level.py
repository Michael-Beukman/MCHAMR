...
from games.minecraft.blocks import AIR, BLOCKS_TO_USE_REV, BRICK_BLOCK
from games.minecraft.new.minecraft_level import MinecraftLevel


class MinecraftBinaryHouseLevel(MinecraftLevel):
    ...
    def __init__(self, width=10, height=10, depth=10):
        ...
        self.minecraft_mapping = [AIR, BRICK_BLOCK]